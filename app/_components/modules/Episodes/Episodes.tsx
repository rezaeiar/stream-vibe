                ...
                <div className="flex flex-col gap-4 lg:gap-5 bg-black-6 border border-black-15 py-8 px-12 rounded-xl">
                    <div className="flex items-center justify-between">
                        <div className="flex gap-2.5 items-center">
                            <h4 className='text-base lg:text-xl 2xl:text-2xl font-manrope-semibold text-white'>
                                Season 01
                            </h4>
                    ...
                    <div className="flex flex-col">
                        <div className="border-t border-black-15 py-5 lg:py-8 2xl:py-10 flex flex-col lg:flex-row gap-4">
                            <div className="flex items-center gap-4">
                                <span className='font-semibold text-2xl text-gray-60'>
                                    01
                                </span>
                                <div className="w-full lg:w-36">
                                    <Image
                                        ...
                                        height="100"
                                        sizes="100vw"
                                        className="rounded-xl border border-black-15 w-full"
                                    />
                                </div>
                            </div>
                            <div className="flex flex-col">
                                <div className="flex flex-col justify-center gap-3.5">
                                    <h3 className='font-manrope-semibold text-base lg:text-lg 2xl:text-xl text-white'>
                                        Chapter One : The Vanishing of Will Byers
                                    </h3>
                                    <span className='font-manrope-regular text-gray-60 text-base 2xl:text-lg hidden lg:block'>
