        ...
        <div className=''>
            <div className="container">
                <div className="relative rounded-xl h-[468px] lg:h-[710px] 2xl:h-[834px] overflow-hidden">
                    ...
                    <Image
                        src="/images/banners/video-trailer.jpg"
                        alt="video-trailer"
                        width="100"
                        height="100"
                        sizes="100vw"
                    ...
                    />
                    <div className="relative z-20 h-full text-gray-99 flex flex-col items-center justify-end px-6 py-4 gap-10 2xl:gap-12">
                        <div className="flex flex-col gap-5 2xl:gap-8 w-full">
                            <div className="flex flex-col gap-0.5 2xl:gap-1">
                                <h1 className='text-gray-99 text-2xl lg:text-3xl 2xl:text-4xl font-manrope-bold text-center'>
                                    Avengers : Endgame
                                </h1>
                            ...
                            <div className="flex flex-col lg:flex-row gap-5 justify-center items-center">
                                <button className='bg-red-45 text-sm 2xl:text-lg rounded-md py-3.5 2xl:py-4 px-5 text-gray-99 w-full lg:w-auto'>
                                    Play Now
                                </button>
